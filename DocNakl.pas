...
type
  TDocNaklForm = class(TMegaForm, IMegaDocNaklForm)
    ...
    dsNote_mTotalSumAsString: TStringField;
    dsNote_mNASH_KOD: TStringField;
    dsNote_mNOTES: TStringField;
    dsNote_mORDER_NUM: TStringField;
    dsNote_mNUMBER: TStringField;
    ...
    dsDocNumberDOC_NUMBER: TStringField;
    ...
    DocPosSPRAV_MATER_CATEGORY_NAME: TStringField;
    ...
    N133: TMenuItem;
    N134: TMenuItem;
    strngfldListsDocPosGDOCUMENT: TStringField;
